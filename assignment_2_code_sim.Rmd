...
if(params$save_plots == TRUE){
  png("s1fig4.png", width = 800, height = 800)
}
plot(y = true_delta_err, simulations, type = 'l', lty = 0, ylim = c(0.09, 0.4), col = "red",
...
text(0, true_delta_err[1]+0.02, paste0("Heding with true Delta"), col = "red", adj = 0)
...
text(6100, w_05_delta_err_5[8], paste0("5"), col = "blue", adj = 0)
text(6100, w_05_delta_err_6[8], paste0("6"), col = "blue", adj = 0)
text(6100, w_05_delta_err_7[8], paste0("7"), col = "blue", adj = 0)
text(6100, w_05_delta_err_8[8], paste0("8"), col = "blue", adj = 0)
text(6100, w_05_delta_err_9[8], paste0("9"), col = "blue", adj = 0)
...
plot(y = true_delta_err_mean, simulations, type = 'l', lty = 0, ylim = c(0.09, 1), col = "red") +
...
text(6100, pricing_delta_err_3_mean[8], paste0("3"), col = "orange", adj = 0)
text(6100, pricing_delta_err_4_mean[8], paste0("4"), col = "orange", adj = 0)
text(6100, pricing_delta_err_5_mean[8], paste0("5"), col = "orange", adj = 0)
text(6100, pricing_delta_err_6_mean[8], paste0("6"), col = "orange", adj = 0)
text(6100, pricing_delta_err_7_mean[8], paste0("7"), col = "orange", adj = 0)
text(6100, pricing_delta_err_8_mean[8], paste0("8"), col = "orange", adj = 0)
text(6100, pricing_delta_err_9_mean[8], paste0("9"), col = "orange", adj = 0)
text(6100, w_05_delta_err_3_mean[8], paste0("3"), col = "blue", adj = 0)
text(6100, w_05_delta_err_4_mean[8], paste0("4"), col = "blue", adj = 0)
text(6100, w_05_delta_err_5_mean[8], paste0("5"), col = "blue", adj = 0)
text(6100, w_05_delta_err_6_mean[8], paste0("6"), col = "blue", adj = 0)
text(6100, w_05_delta_err_7_mean[8], paste0("7"), col = "blue", adj = 0)
text(6100, w_05_delta_err_8_mean[8], paste0("8"), col = "blue", adj = 0)
text(6100, w_05_delta_err_9_mean[8], paste0("9"), col = "blue", adj = 0)
text(0, 0, "K = 1, T = 1, vol = 0.2, dt = 1/52, #repetitions = 1000", adj = 0)
if(params$save_plots == TRUE){
  dev.off()
}
