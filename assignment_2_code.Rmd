...
for(j in 1:2){
  for(i in 1:length(simulations)){
    ...
    err <- calculate_hedge_error(dt, Tt, num_rep, K, sigma, St = St, S0 = S_0, calculate_delta, pol_degree = 7, w = 0.5)
...
plot(y = true_delta_err, simulations, type = 'b', ylim = c(0.01, 0.14), col = "red") +
